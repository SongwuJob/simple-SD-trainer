...
def parse_args(input_args=None):
    ...
    parser.add_argument("--json_file", default=None, type=str, required=True, help="the data json file.")
    parser.add_argument(
        "--train_data_dir",
        type=str,
        default=None,
    ...
    parser.add_argument("--width", type=int, default=1024, help="the width of trained images")
    parser.add_argument("--height", type=int, default=1024, help="the height of trained images")
    parser.add_argument("--repeats", type=int, default=1, help="the repeat num of trained samples")
            ...
            if accelerator.sync_gradients:
                ...
                if accelerator.distributed_type == DistributedType.DEEPSPEED or accelerator.is_main_process:
                    if global_step % args.checkpointing_steps == 0:
                        unet_lora_state_dict = convert_state_dict_to_diffusers(get_peft_model_state_dict(unwrap_model(unet)))

                        if args.train_text_encoder:
                            text_encoder_lora_layers = convert_state_dict_to_diffusers(get_peft_model_state_dict(unwrap_model(text_encoder_one)))
                            text_encoder_2_lora_layers = convert_state_dict_to_diffusers(get_peft_model_state_dict(unwrap_model(text_encoder_two)))
                        else:
